...
@Entity
public class PeceraMarina extends Pecera{
    @Basic
    private String dosificadora;
    private String sump;

    public PeceraMarina() {
    }

    public PeceraMarina(String dosificadora, String sump) {
    ...
    public void setDosificadora(String dosificadora) {
        this.dosificadora = dosificadora;
    }
